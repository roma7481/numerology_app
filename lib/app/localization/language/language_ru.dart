...
class LanguageRu extends Languages {
  ...
  @override
  String get support_ticket_body => 'Пожалуйста, опишите проблему, шаги для её воспроизведения и приложите соответствующие скриншоты.';
  ...
  String get infoWarning =>
      '\n\nВажно: Если вы заметили что данная характеристика не полностью совпадает с вашей, то обязательно обратите внимание '
      'на другие нумерологические параметры\. Часто случается что те или иные нумерологические показатели проявлены у разных людей в большей '
      'или меньшей степени поэтому для составления полного портрета человека важно учитывать все нумерологические параметры вместе. Старайтесь '
      'сопоставить несколько нумерологических параметров и составить из них полную картинку. Пробуйте и у вас всё получится!';
