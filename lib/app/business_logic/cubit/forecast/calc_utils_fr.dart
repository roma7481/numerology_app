...
class CalcUtilsFr extends ForecastCalcUtils {
  ...
  Future<String> _getDayInfo() async {
    return _getInfo('PERSONAL_DAY_FR');
  }

  Future<String> _getLuckyInfo() async {
    return _getInfo('DAILY_LUCKY_NUMBER_FR');
  }

  Future<String> _getMonthlyInfo() async {
    return _getInfo('PERSONAL_MONTH_FR');
  }

  Future<String> _getYearInfo() async {
    return _getInfo('PERSONAL_YEAR_FR');
  }
