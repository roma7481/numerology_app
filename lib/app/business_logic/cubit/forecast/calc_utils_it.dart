...
class CalcUtilsIt extends ForecastCalcUtils {
  const CalcUtilsIt();
  ...
  Future<String> _getDayInfo() async {
    return _getInfo('PERSONAL_DAY_IT');
  }

  Future<String> _getLuckyInfo() async {
    return _getInfo('DAILY_LUCKY_NUMBER_IT');
  }

  Future<String> _getMonthlyInfo() async {
    return _getInfo('PERSONAL_MONTH_IT');
  }

  Future<String> _getYearInfo() async {
    return _getInfo('PERSONAL_YEAR_IT');
  }
