...
class CalcUtilsEs extends ForecastCalcUtils {
  @override
  ...
  Future<Map<String, String>> _getDayInfo() async {
    return _getInfo('PERSONAL_DAY_ESP');
  }

  Future<Map<String, String>> _getLuckyInfo() async {
    return _getInfo('DAILY_LUCKY_NUMBER_ESP');
  }

  Future<Map<String, String>> _getMonthlyInfo() async {
    return _getInfo('PERSONAL_MONTH_ESP');
  }

  Future<Map<String, String>> _getYearInfo() async {
    return _getInfo('PERSONAL_YEAR_ESP');
  }
