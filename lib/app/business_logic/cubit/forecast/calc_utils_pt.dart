...
class CalcUtilsPt extends ForecastCalcUtils {
  ...
  Future<String> _getDayInfo() async {
    return _getInfo('PERSONAL_DAY_PORT');
  }

  Future<String> _getLuckyInfo() async {
    return _getInfo('DAILY_LUCKY_NUMBER_PORT');
  }

  Future<String> _getMonthlyInfo() async {
    return _getInfo('PERSONAL_MONTH_PORT');
  }

  Future<String> _getYearInfo() async {
    return _getInfo('PERSONAL_YEAR_PORT');
  }
